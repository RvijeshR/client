...
function Dashboard() {
  ...
  return (
    <div>
      <div className="grid grid-cols-3 gap-4 mt-5 flex-wrap">
        <div className="col-span-3 md:col-span-1 border-2 border-gary-900">
          <h2 className='text-xl mb-5'>Pending Tasks</h2>
          {pendingTasks.map(task => (
            <div key={task._id} className={`flex-wrap relative p-4 rounded bg-gray-100 m-2 border-2 border-gray-200  bg-gray-200`} onClick={() => handleTaskClick(task)}>
        ...
        <div className="col-span-3 md:col-span-1  border-2 border-gary-900">
          ...
          {completedTasks.map(task => (
            <div key={task._id} className=" flex-wrap relative p-4 rounded bg-gray-200 m-2 border-2 border-gray-200" onClick={() => handleTaskClick(task)}>
